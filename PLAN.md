...
- Action Plan: 3 стъпки (веднага / 30 дни / постоянен контрол)
- Контролен списък „Готовност за SAF-T"
- Минимални изисквания към софтуерния доставчик
...
- Данъчни рискови индикатори (амортизации, вечни салда, запаси, смесени разходи)
